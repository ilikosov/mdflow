...
describe('ColumnsModal', () => {
  ...
  it('moves column up when up arrow button is clicked', () => {
    ...
    const inProgressUpButton = Array.from(upButtons).find(btn => 
      btn.textContent === '↑' && !btn.hasAttribute('disabled')
    );
  ...
  it('disables down button for last column', () => {
    ...
    const downButtons = Array.from(document.querySelectorAll('button'))
